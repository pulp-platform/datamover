...
def main():
    ...
    parser.add_argument("--output-filename",type=str, default="data.h",      dest="output",          help="Output header filename")
    parser.add_argument("--count",          action="store_true",       dest="count",           help="Use counting stimuli instead of random (for debugging)")
    args = parser.parse_args()

    # Check configuration: maximum tensor size limited by memory divided by three (input, output, golden)
