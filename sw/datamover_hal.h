...
static inline __attribute__((always_inline)) void datamover_program(const datamover_cfg_t *cfg) {
  ...
  r->in_stride3       = cfg->in_stride3;
  r->in_stride4       = cfg->in_stride4;
  r->in_len_d0_d1     = cfg->in_len_d0_d1;
  r->in_len_d2_d3     = cfg->in_len_d2_d3;
  r->out_stride0      = cfg->out_stride0;
  r->out_stride1      = cfg->out_stride1;
  r->out_stride2      = cfg->out_stride2;
  r->out_stride3      = cfg->out_stride3;
  r->out_stride4      = cfg->out_stride4;
  r->out_len_d0_d1    = cfg->out_len_d0_d1;
  r->out_len_d2_d3    = cfg->out_len_d2_d3;
